...
namespace Bootcamp.Repository.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<bool> TransferByStoreProcedure(AccountTransfer accountTransferCommand)
        {
            var sp =
        ...
        public async Task<bool> Transfer(AccountTransfer accountTransferCommand)
        {
